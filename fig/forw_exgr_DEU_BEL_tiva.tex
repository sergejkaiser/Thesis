% Created by tikzDevice version 0.10.1 on 2016-08-23 07:22:25
...
\path[fill=fillColor] ( 93.25, 14.54) rectangle (444.39, 37.53);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] (101.13, 18.80) rectangle (115.59, 33.26);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{77,175,74}

\path[draw=drawColor,line width= 0.6pt,line join=round] (102.58, 26.03) -- (114.14, 26.03);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{77,175,74}

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (108.36, 26.03) circle (  1.96);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{gray}{0.80}
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] (354.12, 18.80) rectangle (368.57, 33.26);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{127,38,39}

\path[draw=drawColor,line width= 0.6pt,line join=round] (355.56, 26.03) -- (367.12, 26.03);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{127,38,39}

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (361.34, 22.98) --
	(363.99, 27.56) --
	(358.70, 27.56) --
	(361.34, 22.98);
\end{scope}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (117.39, 22.72) {FVAX Belgium};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (283.83, 22.72) {FVAX Germany};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (370.38, 22.72) {EXGR Germany};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}
