...
%           \\ \midrule
%               \multicolumn{4}{c}{Dependent Variablegross exports} \\\midrule
...
%        &  \multicolumn{1}{c}{Full Sample}&\multicolumn{1}{c}{Without primary industries}&\multicolumn{1}{c}{Without primary industries $\text{high}^1$} %& \multicolumn{1}{c}{EU}
%             \\ \midrule
%                        \multicolumn{4}{c}{Dependent Variableback. value-added exports} \\
%\midrule
...
%          %  \multicolumn{1}{c}{EU}
%                        \multicolumn{4}{c}{Dependent Variableforw. value-added exports} \\
%\midrule
