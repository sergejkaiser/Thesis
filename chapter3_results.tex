...
The IV estimates of $\theta$  show following results.
 ...
 Second, the pattern for both dependent variables shows that the estimate from the sample excluding the primary industries is somewhat decreased, yet statisically not significant.
 ...
 A higher estimate of $\theta$ implies a decreased dispersion of relative cost, which is not surprising for the sample with high income countries.\par
 The estimates of $\theta$ for forward value-added exports do not show a clear pattern.
The estimates of  $\theta$ with forward value-added exports are reduced compared to the other estimates and show only little variation across the samples.
Especially, I note that the estimate for the forth sample does not show an inceased point estimate.  \par
  Comparing to the estimates to the results of \textcite{costinot}, I find that the estimates are comparable.% e.g  ($\theta$11.1 SE 0.981).
