...
Economics from the KU Leuven. Especially  I want to thank my promotor Liza Archanskaia for her helpful comments and discussions, helping me to advance this thesis. %Furthermore, I want to thank the fellow students:  Burak,  Kazimira , Joana, Moritz, Nurul, Simon, Sean and Thomas, with whom I spent a lot of hours working on this thesis. Especially, I want to thank  Moritz, Nurul and Ilja for their valuable comments in the earlier stages of the thesis.
Leuven, 15/03/2016.
\end{flushright}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{chapter1}
\include{chapter3}
%\input{chapter3_ricardo}
\include{Math_theorem_generalization}
\input{chapter3_estimation}
\input{chapter3_results}
\input{chapter3_relative_ranking}
\include{chapter4}
\include{chapter5}
\clearpage
\printbibliography
